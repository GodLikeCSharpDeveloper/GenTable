    ...
    public partial class @try : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategoryModel", x => new { x.CategoryModelsId, x.ProductModelsId });
                    table.ForeignKey(
                        name: "FK_ProductCategoryModel_Categories_CategoryModelsId",
                        column: x => x.CategoryModelsId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCategoryModel_Products_ProductModelsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Test", x => new { x.ProductModelId, x.OrderModelId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategoryModel_ProductModelsId",
